  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <h1 className="font-serif text-3xl font-bold text-slate-900 tracking-tight">Refer a Friend</h1>
        <p className="text-xs text-slate-500 mt-1">Earn 20% lifetime volume rebates on every trader you invite</p>
      </div>
      ...
      <div className="bg-white border border-slate-200/90 rounded-2xl sm:rounded-3xl p-6 sm:p-8 space-y-6 shadow-xs">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="font-serif text-lg font-bold text-slate-900">Your Unique Referral Link</h3>
            <p className="text-xs text-slate-500">Share this link to credit new trader sign-ups under your account</p>
          </div>
        </div>

        <div className="flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-xl p-2 pl-4">
          <span className="font-mono text-xs text-slate-700 truncate flex-1">{referralLink}</span>
          <button
            type="button"
            onClick={handleCopy}
            className="px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer shadow-xs"
          >
